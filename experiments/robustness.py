...
robustness_results.to_csv(os.path.join(output_dir,f'robustness_results_{timestamp}_{num_voters}_{num_projects}_{total_op_tokens}_{num_rounds}.csv'), index=False)
